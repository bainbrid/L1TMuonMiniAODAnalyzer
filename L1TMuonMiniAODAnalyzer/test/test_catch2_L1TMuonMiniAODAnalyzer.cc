...
static constexpr auto s_tag = "[L1TMuonMiniAODAnalyzer]";

TEST_CASE("Standard checks of L1TMuonMiniAODAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("L1TMuonMiniAODAnalyzer"
